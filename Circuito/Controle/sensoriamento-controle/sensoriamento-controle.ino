...
#define WIFISSID "HperLink Fibra Marli"
#define PASSWORD "31012706"
...
float tempControle = 30; // temperatura que ativa o controle
...
void loop() {
  ...
  // condição para ativar / desativar o relé
   if(tempInt < tempControle){
...
void sendToAPI(float tempInt, float umidInt, float tempExt, float umidExt) { //, float tempAlimento) {
  ...
  String url = "https://brisa-ts.dev.amo.delivery/api/";
  String data = "{";
